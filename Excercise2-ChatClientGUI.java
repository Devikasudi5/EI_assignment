...
bottomPanel.add(exitButton, BorderLayout.EAST); // Add the exit button to the bottom 
panel
...
e.printStackTrace();
JOptionPane.showMessageDialog(this, "Error connecting to the server", "Connection 
error",
